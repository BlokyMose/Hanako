...
//     version 1.5.1
//     from Assets/Settings/PlayerInput/KaidanInput.inputactions
//
...
{
    public partial class @KaidanInput: IInputActionCollection2, IDisposable
    {
    ...
    ""controlSchemes"": [
        ...
        private readonly InputAction m_Knife_Cursor;
        private readonly InputAction m_Knife_Click;
        public struct KnifeActions
        {
            private @KaidanInput m_Wrapper;
            public KnifeActions(@KaidanInput wrapper) { m_Wrapper = wrapper; }
            public InputAction @Cursor => m_Wrapper.m_Knife_Cursor;
            public InputAction @Click => m_Wrapper.m_Knife_Click;
        ...
        {
            private @KaidanInput m_Wrapper;
            public HanakoActions(@KaidanInput wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @KaidanInput m_Wrapper;
            public UIActions(@KaidanInput wrapper) { m_Wrapper = wrapper; }
